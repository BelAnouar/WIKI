...
<body>
    ...
    <div class="flex w-full  h-screen font-sans text-gray-900 bg-white  overflow-x-auto">
        <aside class="flex relative flex-col py-4 px-6 w-52 border-r border-gray-200 ">
            ...
            <ul class="flex flex-col gap-y-5 pt-12">
                <li>
                    ...
                    <a href="category" class="flex gap-x-3 items-center group">
                        ...
                        <span class="inline-block text-lg leading-6 text-gray-700 group-hover:text-gray-800 group-hover:font-semibold"> Add category</span>
                    </a>
                    <a href="tag" class="flex gap-x-3 items-center group">
